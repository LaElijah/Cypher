...
namespace Graphics
{
	...
	private: 	
	    std::vector<Graphics::Texture> m_LoadedTextures;
		...
		// TODO: FIX
           ...
           */ 
                return Mesh(vertices, indices, textures, "debug");
            }
            ...
            )
            {
                ...
                {    
                    ...
                    { 
                        ...
                        {
                            //textures.push_back(texturesLoaded[j]); //TODO
                            skip = true;
                            break;
                        } 
                    }
                    ...
                    {      
            	        ...
            	        //texture.directory = this->directory; // TODO: AT PROCESSNODE 
