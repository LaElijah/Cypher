...
namespace Graphics 
{
    ...
    {
        public: 
            static std::vector<std::filesystem::directory_entry> getDirectoryContents(std::string path);
            static std::vector<std::filesystem::directory_entry> getDirectoryContents(std::filesystem::directory_entry path);
