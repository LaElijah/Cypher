...
std::vector<std::filesystem::directory_entry> Graphics::FileReader::getDirectoryContents(std::string path)
{
    ...
    auto it = std::filesystem::directory_iterator(path, options, ec);
...
std::vector<std::filesystem::directory_entry> Graphics::FileReader::getDirectoryContents(std::filesystem::directory_entry path)
{
    std::vector<std::filesystem::directory_entry> files;
    auto options = std::filesystem::directory_options::skip_permission_denied;
    std::error_code ec;
